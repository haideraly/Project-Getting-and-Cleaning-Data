...
The tidy dataset output is created in the same working directory where the "run_analysis.R" file is located. The file will be named 
"tidydata-Haider.txt"
PLEASE MAKE SURE THAT that the extracted Samsung/Smartphones activity dataset is contained within a folder "UCI HAR Dataset" in the working 
directory and follows the convention mentioned in "Location of the script and activity dataset" section above.
...
There are comments for almost all individual steps/code lines within script file please refer to the original file for individual code lines and 
exaplanation.
